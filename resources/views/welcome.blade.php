...
<head>
    ...
    <title>Clase Laravel 2 - Ejemplo 1</title>
...
<body>
    <div class="flex-center position-ref full-height">
        ...
        <div class="content">
            ...
            <div class="links">
                <a href="{{ route ('usuarios') }}">Pagina Usuarios</a>
                <a href="{{ route ('muestra_usuario', 7) }}">Muestra Usuario</a>
                <a href="{{ route ('nuevo_usuario') }}">Nuevo Usuario</a>
                <a href="{{ route ('saludo', 'Matias') }}">Saludar</a>
                <a href="{{ route ('error') }}">Pagina de error</a>
